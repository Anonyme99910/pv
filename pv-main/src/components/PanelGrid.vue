  ...
  <div class="relative">
    <div class="grid grid-cols-16 gap-1 max-h-96 overflow-y-auto p-2">
      <div
        ...
        :title="`${panel.id}\nStatus: ${panel.status}\nEfficiency: ${formatNumber(panel.efficiency)}%\nTemp: ${formatNumber(panel.temperature)}°C`"
